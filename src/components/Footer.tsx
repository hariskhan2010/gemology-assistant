    ...
    <footer className="mt-auto border-t border-border bg-background-secondary" role="contentinfo">
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <div className="flex items-center gap-2 text-lg font-bold font-heading">
              ...
              <span className="text-text-primary">GemSage</span>
            </div>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-text-secondary">
              <li><a href="/assistant" className="hover:text-text-primary transition-colors">Assistant</a></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-2 text-sm text-text-secondary">
              ...
              <li><a href="#" className="hover:text-text-primary transition-colors">Gem Guide</a></li>
        ...
        <div className="mt-8 flex items-center justify-between border-t border-border pt-6">
          <p className="text-xs text-text-muted">&copy; 2026 GemSage. All rights reserved.</p>
