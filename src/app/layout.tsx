...
export const metadata: Metadata = {
  ...
  description: "GemSage is an AI gemologist for instant gem identification, faceting angles, and stone properties. Browse 25+ gemstone guides with prices and hardness ratings. Free to use.",
